...
湖南农业大学 `PASS/FAIL/UNKNOWN = 161/5/128`，南农 `91/20/94`，
北大 `99/19/34`。这说明当前生成器已经能产出可检查 Word 和明确证据，
但还没有达到学校模板质量。
...
湖南和南农的大部分分页/分节失败收敛；北大剩余的分页失败主要来自源锚点匹配到了
说明文字或目录条目，还需要继续改进“真正单元标题”的匹配排序。
