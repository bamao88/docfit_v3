...
Context: must-read=docs/plans/real-core-v0-generated-template-gap-eval-harness.md, README.md, SPEC.md, docs/agents/bootstrap-eval-runbook.md, src/docfit/cli/main.py, src/docfit/stages/template_parse/runner.py, src/docfit/stages/render/runner.py, src/docfit/harness/template_units.py, src/docfit/harness/coverage.py, src/docfit/harness/product_quality.py, src/docfit/harness/word_evidence.py, src/docfit/ooxml/package.py, eval_profiles/real-core-v0/profile.yaml, standards/targets/*/v1/template_unit_contract.yaml, tests/contract/test_real_core_baseline_harness.py, tests/contract/test_real_core_four_stage_problem_checks.py, tests/contract/test_contract_gates.py, tests/e2e/test_bootstrap_cli.py; useful=docs/human/real-core-v0-product-quality-review.md, docs/human/real-core-v0-four-stage-problem-checks.md, runs/eval/real-core-v0/**/artifacts/template_artifact.json, runs/eval/real-core-v0/**/final.docx, runs/eval/real-core-v0/**/evidence/word_image_evidence.json; avoid-unless-needed=整份 docs/human/real-core-v0-review-packet.md 和 runs/eval/** 页面图片大文件。
...
- 页眉页脚检查现在会解析 `word/_rels/document.xml.rels` 和 section 里的
  header/footer 引用，并按单元匹配位置落到对应 Word section。能确定页眉或页码
  不符合单元规则时会报 `template_generation_header_footer_mismatch` 或
...
uv run docfit eval template-gap --school hunannongye --generated-template test_inputs/targets/hunannongye/raw/source_template.docx --out /tmp/docfit_template_gap_hunannongye
# status = FAIL
...
│
├── standards/targets/<target_id>/v1/
...
| `standards/targets/*/v1/template_unit_contract.yaml` | 模板验收标准。里面的 `expected.units` 是当前最重要的结构化标准 |
...
```text
runs/eval/<case_or_school>/artifacts/
├── template_artifact.json
├── generated_template.docx
├── generated_template_tree.json
├── template_gap_report.json
