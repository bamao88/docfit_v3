...
| 02 | optimization plan | `docs/plans/template-parse-refactor-t2-unit-recognition-plan-02-post-phase2-residual-fix.md` | draft | Phase 2 后残余修复计划；字段消费契约已拆到 data contract |
