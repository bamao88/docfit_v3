...
| 02 | optimization plan | `docs/plans/template-parse-refactor-t2-unit-recognition-plan-02-post-phase2-residual-fix.md` | draft | Phase 2 后残余修复计划，补充 T2 数据转换逻辑与字段消费契约 |
