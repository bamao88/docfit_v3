...
| `docs/current/docx4j-diagnostics.md` | docx4j 旁路诊断：比较 Java/docx4j 和当前 Python inspector 分别看到了哪些 Word 证据 |
...
| 诊断 Python inspector 是否漏掉 Word 可见对象 | `docs/current/docx4j-diagnostics.md` |
| 看当前进展和下一步 | `STATUS.md` |
